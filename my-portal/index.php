<?php include 'includes/header.php'; ?>
 ...
 <!-- I added this body content only after created a new folder named: old_index.html and
  moved my index.html in here--> <!--Then, I renamed my index.php to index.html-->
  <!-- To then, create a new index.php page--> <!--Then, I call for the include to created a new
   page with header.php and footer.php--> <!--Lastly, I included my body content-->

<!--Body content starts here-->
<!--BODY CONTENT STARTS HERE. IT WAS COPIED AND PASTED HERE FROM THE OLD VERSION OF INDEX.HTML-->
 <picture class="profile">
        ...
        <h2 class="subheader"></h2> <!-- I could add subheaders anywhere comiing from the portal-config.php-->
