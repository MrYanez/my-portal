...
<body>
	...
	<?php
        ...
        $toAddress = "myitskillsnahum@gmail.com";  //place your/your client's email address here
        $toName = "NahumYanez"; //place your client's name here
        $website = "ITContactForm";  //place NAME of your client's website
